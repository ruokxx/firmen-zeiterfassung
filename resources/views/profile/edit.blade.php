                                ...
                                <div class="flex space-x-2">
                                    <form action="{{ route('report.send') }}" method="POST" class="inline flex items-center gap-2">
                                        ...
                                        <label class="inline-flex items-center cursor-pointer mr-2">
                                            <input type="checkbox" name="include_carryover" value="1" checked class="rounded border-gray-600 bg-gray-700 text-blue-600 shadow-sm focus:ring-blue-500 focus:ring-offset-gray-800 h-4 w-4">
