    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 border border-gray-700">
                ...
                <h3 class="text-lg font-bold mb-4 text-gray-100">FAQ bearbeiten</h3>
                ...
                <form method="POST" action="{{ route('admin.faqs.update', $faq) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="answer" name="answer" class="block mt-1 w-full border-gray-600 bg-gray-900 text-gray-300 focus:border-orange-500 focus:ring-orange-500 rounded-md shadow-sm min-h-[150px]" required>{{ old('answer', $faq->answer) }}</textarea>
                    ...
                    <div class="flex gap-4 mb-6">
                        ...
                        <div class="flex-1 flex flex-col justify-end">
                            <label for="is_active" class="inline-flex items-center text-gray-300 cursor-pointer h-10">
                                <input id="is_active" type="checkbox" class="rounded border-gray-600 text-orange-600 shadow-sm focus:ring-orange-500 bg-gray-900" name="is_active" value="1" {{ old('is_active', $faq->is_active) ? 'checked' : '' }}>
