        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-700 p-6">
                <form method="GET" action="{{ route('admin.construction-sites.index') }}" class="flex flex-col lg:flex-row gap-4 items-end">
                    ...
                    <div class="flex flex-col lg:flex-row gap-2 w-full lg:w-auto mt-4 lg:mt-0 items-end">
                        <button type="submit" class="w-full lg:w-auto bg-orange-600 hover:bg-orange-500 text-white font-bold py-2 px-4 rounded transition h-10 mb-[1px] flex items-center justify-center">
                            Filtern
                        </button>
                        @if($search || ($userSearch ?? false) || ($dateFrom ?? false) || ($dateTo ?? false))
                            <a href="{{ route('admin.construction-sites.index') }}" class="w-full lg:w-auto bg-gray-600 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded transition h-10 mb-[1px] flex items-center justify-center" title="Filter zurücksetzen">
